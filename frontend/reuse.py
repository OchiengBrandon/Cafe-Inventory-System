...
class SupplierOrderCreator(tk.Toplevel):
    ...
    def generate_report(self):
        ...
        try:
            ...
            print("Selected supplier not found in the list.")
            return
        ...
        for product_dropdown, quantity_entry in zip(self.product_dropdowns, self.quantity_entries):
            try:
                ...
                print(f"Selected product '{product_dropdown.get()}' not found in the list.")
                continue
        ...
        print("PDF report generated: order_report.pdf")
